...
public class HermitHutMap extends BuildingMap {
	...
	public HermitHutMap(Handler handler, String firstLayer, HermitHut herH, int index) {
	...
	public void checkExit() {
		if(handler.getWorld().player.getX()>=spawnX&&handler.getWorld().player.getX()<spawnX+64&&handler.getWorld().player.getY()>=spawnY+5) {
