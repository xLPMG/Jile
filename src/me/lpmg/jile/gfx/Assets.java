...
public class Assets {
	...
	public static BufferedImage grass_full, grass_dirtBottom, grass_dirtTop, grass_dirtLeft, grass_dirtRight,
			grass_dirtCBL, grass_dirtCBR, grass_dirtCTL, grass_dirtCTR, grass_ramp, grass_ramp_shadowless,
			grass_ramp_shadowHalf;
	...
	static {
		...
		hermit_right[0] = hermit_sheet.crop(player_sheet_width * 0, player_sheet_height, player_sheet_width,
				player_sheet_height);
		hermit_right[1] = hermit_sheet.crop(player_sheet_width * 1, player_sheet_height, player_sheet_width,
				player_sheet_height);
		hermit_left[0] = hermit_sheet.crop(player_sheet_width * 2, player_sheet_height, player_sheet_width,
				player_sheet_height);
		hermit_left[1] = hermit_sheet.crop(player_sheet_width * 3, player_sheet_height, player_sheet_width,
				player_sheet_height);
		hermit_idle[0] = hermit_sheet.crop(player_sheet_width * 0, player_sheet_height * 2, player_sheet_width,
				player_sheet_height);
		...
		grass_ramp_shadowHalf = floor_sheet.crop(default_width * 8, default_height, default_width, default_height);
		grass_ramp_shadowless = floor_sheet.crop(default_width * 9, default_height, default_width, default_height);
		...
		tall_grass_bottom = static_entities_sheet.crop(default_width * 4, default_height * 4, default_width,
				default_height);
