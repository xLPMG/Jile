...
public class Chain extends ArmorItem{

	public Chain(BufferedImage texture, String name, int id, int buyingPrice, int sellingPrice, String description, int manaPoints, int manaRegenerationPoints, int healthRegenerationPoints) {
