...
public class UITitleWhite extends UIObject{

	private String text;
	private String version="";
	
	public UITitleWhite(float x, float y, int width, int height, String text) {
		super(x, y, width, height);
		this.text = text;
	}
	public UITitleWhite(float x, float y, int width, int height, String text, String version) {
		super(x, y, width, height);
		this.text = text;
